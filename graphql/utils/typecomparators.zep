...
class TypeComparators
{
     ...
     * @return bool
     */
    static function isTypeSubTypeOf(<Schema> schema, <Type> maybeSubType, <Type> superType) -> bool
    {
     ...
     * @return bool
     */
    static function doTypesOverlap(<Schema> schema, <CompositeType> typeA, <CompositeType> typeB) -> bool
    {
        var type;
        ...
        if typeA instanceof AbstractType {
            if typeB instanceof AbstractType {
                ...
                for type in schema->getPossibleTypes(typeA) {
